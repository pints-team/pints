...
def test_relativistic_on_two_dim_gaussian(n_iterations=None):
...
def test_relativistic_on_high_dim_gaussian(n_iterations=None):
    if n_iterations is None:
        n_iterations = 5000
...
def test_relativistic_on_correlated_gaussian(n_iterations=None):
    if n_iterations is None:
        n_iterations = 5000
