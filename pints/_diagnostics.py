...
def effective_sample_size(samples):
    ...
    warnings.warn(
        'The function `effective_sample_size` is deprecated and will be '
        'removed in future versions of Pints. Please use '
        '`pints.diagnostics.effective_sample_size` instead.')
...
def rhat(chains, warm_up=0.0):
    ...
    # Deprecated on 2021-02-14
    warnings.warn(
        'The function `rhat` is deprecated and will be '
        'removed in future versions of Pints. Please use '
        '`pints.diagnostics.rhat` instead.')
...
def rhat_all_params(chains):
    ...
    warnings.warn(
        ...
        ' Please use `pints.diagnostics.rhat` instead.')
