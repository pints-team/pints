...
class GaussianProcessDenseMatrix : public GaussianProcess<D> {
  ...
  using OperatorKernel_t = KernelMatrix<Particles_t, Particles_t, Kernel_t>;
  using GradientSigmaOperatorKernel_t =
      KernelMatrix<Particles_t, Particles_t, GradientSigmaKernel_t>;
  using GradientLengthscaleOperatorKernel_t =
      KernelMatrix<Particles_t, Particles_t, GradientLengthscaleKernel_t>;
...
#include "GaussianProcessDenseMatrix.tcc"
