...
class StochasticDecayModel(pints.ForwardModelS1, ToyModel):
    ...
    *Extends:* :class:`pints.ForwardModel`, :class:`pints.toy.ToyModel`.
    ...
    def simulate(self, parameter, times):
        ...
        return self._simulate(parameter, times, False)

    def simulateS1(self, parameter, times):
        """ See :meth:`pints.ForwardModelS1.simulateS1()`. """
        return self._simulate(parameter, times, True)

    def _simulate(self, parameter, times, sensitivities):
        if parameter <= 0:
