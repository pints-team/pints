...
class RaoBlackWellACMCMC(pints.AdaptiveCovarianceMCMC):
    ...
    For iteration t = 0:n_iter:
      ...
      - Update sigma_t+1 = sigma_t + gamma_t+1 *
                        (bar((theta_t+1 - mu_t)(theta_t+1 - mu_t)') - sigma_t)
    endfor

    where bar(X_t+1) = alpha(X_t, Y_t+1) * Y_t+1 +
    ...
    *Extends:* :class:`AdaptiveCovarianceMCMC`
    ...
    def __init__(self, x0, sigma0=None):
        super(RaoBlackWellACMCMC, self).__init__(x0, sigma0)

    def ask(self):
        """ See :meth:`SingleChainMCMC.ask()`. """
        super(RaoBlackWellACMCMC, self).ask()
    ...
    def _initialise(self):
        ...
        """
        super(RaoBlackWellACMCMC, self)._initialise()
    ...
    def tell(self, fx):
        ...
        super(RaoBlackWellACMCMC, self).tell(fx)
