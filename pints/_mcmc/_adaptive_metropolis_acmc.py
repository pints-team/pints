...
class AdaptiveMetropolisACMC(pints.AdaptiveCovarianceMCMC):
    """
    ...
    *Extends:* :class:`AdaptiveCovarianceMCMC`
    ...
    def __init__(self, x0, sigma0=None):
        super(AdaptiveMetropolisACMC, self).__init__(x0, sigma0)

    def ask(self):
        """ See :meth:`SingleChainMCMC.ask()`. """
        super(AdaptiveMetropolisACMC, self).ask()
    ...
    def _initialise(self):
        ...
        """
        super(AdaptiveMetropolisACMC, self)._initialise()
    ...
    def tell(self, fx):
        ...
        super(AdaptiveMetropolisACMC, self).tell(fx)
