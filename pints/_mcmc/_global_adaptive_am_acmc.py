...
class GlobalAdaptiveAM_ACMC(pints.AdaptiveCovarianceMCMC):
    """
    ...
    For iteration t = 0:n_iter:
      ...
      - Update log lambda_t+1 = log lambda_t + gamma_t+1 * (alpha(theta_t, Y_t+1) - self._target_acceptance)
    endfor
    ...
    *Extends:* :class:`AdaptiveCovarianceMCMC`
    ...
    def __init__(self, x0, sigma0=None):
        super(GlobalAdaptiveAM_ACMC, self).__init__(x0, sigma0)

    def ask(self):
        """ See :meth:`SingleChainMCMC.ask()`. """
        super(GlobalAdaptiveAM_ACMC, self).ask()
    ...
    def _initialise(self):
        ...
        """
        super(GlobalAdaptiveAM_ACMC, self)._initialise()
        self._log_lambda = 0

    def tell(self, fx):
        """ See :meth:`pints.AdaptiveCovarianceMCMC.tell()`. """
        super(GlobalAdaptiveAM_ACMC, self).tell(fx)
