...
LOG_SCREEN_1 = [
    ...
    'Iter. Eval. Temperature ESS       Time m:s',
    '0     10     0.9999      9.999924   0:00.0',
    '1     20     0.99975     9.999809   0:00.0',
    '2     30     0.99937     9.999833   0:00.0',
    '3     40     0.99842     9.998985   0:00.0',
    '6     70     0.97488     9.871605   0:00.0',
    '9     100    0.60189     7.456597   0:00.0',
    '10    110    0           7.382798   0:00.0',
]

LOG_FILE = [
    'Iter. Eval. Temperature ESS       Time m:s',
    '0     10     0.9999      9.88839    0:00.0',
    '1     20     0.99        9.604977   0:00.0',
    '2     30     0           1.278803   0:00.0',
]
