...
### Added
- [#1213](https://github.com/pints-team/pints/pull/1213) Added the truncated normal distribution as a log prior. As of [#1214](https://github.com/pints-team/pints/pull/1214), it is called `TruncatedGaussianLogPrior`.
...
### Changed
- [#1214](https://github.com/pints-team/pints/pull/1214) Changed the name of `TruncatedNormalLogPrior` to `TruncatedGaussianLogPrior`
